...
namespace RFIDTrackBin
{
    ...
    public class LoginActivity : AppCompatActivity
    {
        ...
        new string[] { Java.Lang.Class.FromType(typeof(NfcA)).Name }
            ...
            query = "SELECT usuario, password FROM Tb_RFID_Usuarios WHERE idestatus = 1 ORDER BY usuario";
        ...
        public bool getTb_RFID_Login(string usuario, string password)
        {
            ...
            try
            {
                ...
                {
                    string query = "SELECT * FROM Tb_RFID_Usuarios WHERE idEstatus = 1 AND usuario = '" + usuario + "' AND password = '" + password + "'";
